 ...
 * @subpackage  Acl
 */
class FundProject_Acl_Rights extends Tinebase_Acl_Rights_Abstract
{
	const APPROVAL_BUHA = 'approval_buha';
    ...
    public static function getInstance() 
    {
        if (self::$_instance === NULL) {
            self::$_instance = new FundProject_Acl_Rights;
        }
    ...
    private function getTranslatedRightDescriptions()
    {
        ...
        $rightDescriptions = array(
            self::APPROVAL_BUHA => array(
                'text'          => $translate->_('Freigabe Buchhaltung'),
                'description'   => $translate->_('Das Recht ein Projekt buchhalterisch freizugeben'),
            )  
        );
