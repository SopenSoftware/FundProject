<?php
class FundProject_Backend_ProjectRole extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'fp_project_role';
     ...
     * @var string
     */
    protected $_modelName = 'FundProject_Model_ProjectRole';
