<?php
class FundProject_Backend_AppropriationPayout extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'fp_appropriation_payout';
     ...
     * @var string
     */
    protected $_modelName = 'FundProject_Model_AppropriationPayout';
