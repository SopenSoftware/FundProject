<?php
class FundProject_Backend_PromotionArea extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'fp_promotion_area';
     ...
     * @var string
     */
    protected $_modelName = 'FundProject_Model_PromotionArea';
