<?php
class FundProject_Backend_FundsCategory extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'fp_funds_category';
     ...
     * @var string
     */
    protected $_modelName = 'FundProject_Model_FundsCategory';
