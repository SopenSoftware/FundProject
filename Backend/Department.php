<?php
class FundProject_Backend_Department extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'fp_department';
     ...
     * @var string
     */
    protected $_modelName = 'FundProject_Model_Department';
