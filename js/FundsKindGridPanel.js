 ...
 */
Tine.FundProject.FundsKindGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
    ...
    initComponent: function() {
        this.recordProxy = Tine.FundProject.fundsKindBackend;
        ...
        Tine.FundProject.FundsKindGridPanel.superclass.initComponent.call(this);
    },
    initFilterToolbar: function() {
		//var quickFilter = [new Tine.widgets.grid.FilterToolbarQuickFilterPlugin()];	
		this.filterToolbar = new Tine.widgets.grid.FilterToolbar({
            app: this.app,
            filterModels: Tine.FundProject.Model.FundsKind.getFilterModel(),
            defaultFilter: 'query',
